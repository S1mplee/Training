        ...
        public class Application
        {
            ...
            public void Bootstrap()
            {
             ...
             _readModel = new AccountBalanceReadModel(() => listener);
                ...
                var g = Guid.NewGuid();
                //  var cmd = new CreateAccount(g, "Ali");
           //      var cmd = new SetDailyTransfertLimit(Guid.Parse("b9164b87-9266-4452-93e8-6fba13b4db60"), 1000);
                //  var cmd = new DeposeCash(Guid.Parse("b9164b87-9266-4452-93e8-6fba13b4db60"), 2000);
                 var cmd = new WithDrawCash(Guid.Parse("b9164b87-9266-4452-93e8-6fba13b4db60"), 1000);
              //  var cmd = new TransferCash(Guid.Parse("b9164b87-9266-4452-93e8-6fba13b4db60"), 500, DateTime.Now);
